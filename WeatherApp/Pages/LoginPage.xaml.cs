...
public partial class LoginPage : ContentPage
{
    ...
    public LoginPage(ApiService apiService, CitiesService citiesService,
    ...
    private async void BtnSignIn_Clicked(object sender, EventArgs e)
    {
        ...
        if (!response.HasError)
            Application.Current!.MainPage = new AppShell(_apiService, _citiesService, 
    ...
    {
        await Navigation.PushAsync(new RegisterPage(_apiService, _citiesService, 
                                                    _restService, _validator, _weatherData));
    }
}